...
import java.util.List;
    ...
    public static void main(String[] args) {
        ...
        Utilisateur u1 = new Utilisateur(1, "wiem", "ben msahel", "wiem@example.com", "password123", "123 Main St", (byte) 0);
        Utilisateur u2 = new Utilisateur(2, "tttt", "test", "test@example.com", "password456", "456 Elm St", (byte) 0);
        Utilisateur u3 = new Utilisateur(3, "tttt", "tttt", "tttt@example.com", "password456", "456 Elm St", (byte) 0);

        // Créer des objets Reclamation
        Reclamation r1 = new Reclamation(1, 1, "test", "Le vol réservé a été annulé sans préavis, et aucune alternative n'a été proposée.", java.sql.Date.valueOf("2025-02-12"));
        ...
        Reclamation r3 = new Reclamation(5, 2, "Excursion annulée à la dernière minute", "L'excursion que j'avais réservée a été annulée à la dernière minute sans explication valable.", java.sql.Date.valueOf("2025-02-12"));

        // Créer des objets Reponse
        Reponse rep1 = new Reponse(1, 1, "Nous avons pris en compte votre réclamation et travaillons à une solution.", java.sql.Date.valueOf("2025-02-13"));
        Reponse rep2 = new Reponse(2, "Un remboursement vous sera accordé dans les 3 jours ouvrables.", java.sql.Date.valueOf("2025-02-13"));
        Reponse rep3 = new Reponse(2, "test", java.sql.Date.valueOf("2025-02-13"));
        ...
        try {
            ...
            //int idToDelete = 3; // Remplacez par l'ID à supprimer
            //serviceUtilisateur.delete(idToDelete);

            // Supprimer une reclamation par ID
            //int reclamationIdToDelete = 5;  // ID de la réclamation à supprimer
